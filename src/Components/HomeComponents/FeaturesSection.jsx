      ...
      >
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <h2 className="block w-full text-black font-bold text-3xl sm:text-4xl">
            Build an Organization That Your Customers Love
          </h2>
          ...
          <FeatureCard
            icon={
              ...
              >
                ...
                <path d="M12 2l6.5 2.5a2 2 0 0 1 1.5 1.937v6.563a8 8 0 0 1 -3.5 6.5l-4 2.5l-4 -2.5a8 8 0 0 1 -3.5 -6.5v-6.563a2 2 0 0 1 1.5 -1.937l6.5 -2.5z"></path>
              </svg>
            }
            title="Secure"
            description="Our solutions are built with security in mind, ensuring your data is safe and protected."
          />
        </div>
      </section>
    </div>
...
const FeatureCard = ({ icon, title, description }) => (
  <div className="rounded-md border border-neutral-300 bg-white p-8 hover:shadow-lg text-center shadow">
    <div className="button-text mx-auto flex h-12 w-12 items-center justify-center rounded-md border">
      {icon}
    </div>
    <h3 className="mt-6 text-gray-700">{title}</h3>
